  ...
  if(isset($_POST['delete_booking']))
    {
            ...
            $query="update jobs_user set c_n_name=?, c_n_phone=?, c_bookdate=?,  c_book_status=? where u_id=?";
            $stmt = $mysqli->prepare($query);
            $rc=$stmt->bind_param('ssssi',  $c_n_name, $c_n_phone, $c_bookdate, $c_book_status, $u_id);
            $stmt->execute();
                if($stmt)
                {
        ...
        ?>
          <form method ="POST"> 
            ...
            <div class="form-group">
                ...
                <input type="email" readonly placeholder="<?php echo $row->c_n_name;?>" class="form-control" name="c_n_name">
            </div>

            <div class="form-group">
                <label for="exampleInputEmail1">Consultant Contact</label>
                <input type="email" readonly placeholder="<?php echo $row->c_n_phone;?>" class="form-control" name="c_n_phone">
            </div>

        
            <div class="form-group">
                <label for="exampleInputEmail1">Booking Date</label>
                <input type="text" readonly placeholder="<?php echo $row->c_bookdate;?>" class="form-control"   name="c_bookdate">
            </div>

            <div class="form-group">
                <label for="exampleInputEmail1">Booking Status</label>
                <input type="text" readonly placeholder="<?php echo $row->c_book_status;?>" class="form-control" id="exampleInputEmail1"  name="c_book_status">
            </div>
