  ...
  if(isset($_POST['update_user']))
    {
            ...
            $query="update jobs_user set u_fname=?, u_lname=?, u_phone=?, u_addr=?, u_category=?, u_email=?, u_pwd=? where u_id=?";
      ...
      <?php if(isset($succ)) {?>
        ...
        ?>
          <form method ="POST"> 
            ...
            <button type="submit" name="update_user" class="btn btn-success">Update Client</button>
          </form>
          <!-- End Form-->
        <?php }?>
        </div>
